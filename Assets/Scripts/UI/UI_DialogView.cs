...
public class UI_DialogView : MonoBehaviour
{
    ...
    [Header("主界面")]
    [SerializeField]
    private GameObject dialogContainer; // 对话容器
    ...
    [Header("对话框面板")]
    [SerializeField]
    private GameObject dialogPanel; // 对话框面板

    [SerializeField]
    private Image dialogBackground; // 对话框背景

    [SerializeField]
    private TextMeshProUGUI dialogText; // 对话文本

    [SerializeField]
    private TextMeshProUGUI speakerNameText; // 说话者名字

    [Header("角色立绘")]
    [SerializeField]
    private Image leftCharacterPortrait; // 左侧角色立绘

    [SerializeField]
    private Image rightCharacterPortrait; // 右侧角色立绘

    [SerializeField]
    private Transform portraitContainer; // 立绘容器

    [Header("对话控制")]
    [SerializeField]
    private GameObject continueIndicator; // 继续指示箭头

    [SerializeField]
    private Button continueButton; // 继续按钮

    [SerializeField]
    private Button skipButton; // 跳过按钮

    [SerializeField]
    private Button autoButton; // 自动播放按钮

    [SerializeField]
    private Button logButton; // 对话日志按钮

    [Header("选项面板")]
    [SerializeField]
    private GameObject choicePanel; // 选项面板

    [SerializeField]
    private Transform choiceContainer; // 选项容器

    [SerializeField]
    private GameObject choiceButtonPrefab; // 选项按钮预制体

    [Header("动画设置")]
    [SerializeField]
    private float textSpeed = 0.05f; // 打字机效果速度

    [SerializeField]
    private float fadeDuration = 0.3f; // 淡入淡出时间

    [SerializeField]
    private float indicatorBlinkSpeed = 1f; // 指示箭头闪烁速度

    [Header("音效")]
    [SerializeField]
    private AudioClip textTypingSound; // 打字音效

    [SerializeField]
    private AudioClip optionSelectSound; // 选项选择音效

    [SerializeField]
    private AudioClip dialogOpenSound; // 对话打开音效

    [SerializeField]
    private AudioClip dialogCloseSound; // 对话关闭音效
    #endregion
